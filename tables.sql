drop database if exists wikidb; create database wikidb; use wikidb;
...
-- tables.
--
CREATE TABLE IF NOT EXISTS /*_*/user (
...
--
CREATE TABLE IF NOT EXISTS /*_*/user_groups (
  -- Key to user_id
...
--
CREATE TABLE IF NOT EXISTS /*_*/user_newtalk (
  -- Key to user.user_id
...
--
CREATE TABLE IF NOT EXISTS /*_*/user_properties (
...
--
CREATE TABLE IF NOT EXISTS /*_*/archive (
...
--
CREATE TABLE IF NOT EXISTS /*_*/templatelinks (
  -- Key to the page_id of the page containing the link.
...
--
CREATE TABLE IF NOT EXISTS /*_*/imagelinks (
...
--
CREATE TABLE IF NOT EXISTS /*_*/categorylinks (
...
--
CREATE TABLE IF NOT EXISTS /*_*/category (
  -- Primary key
...
--
CREATE TABLE IF NOT EXISTS /*_*/externallinks (
...
--
CREATE TABLE IF NOT EXISTS /*_*/external_user (
...
--
CREATE TABLE IF NOT EXISTS /*_*/langlinks (
  -- page_id of the referring page
...
--
CREATE TABLE IF NOT EXISTS /*_*/site_stats (
...
--
CREATE TABLE IF NOT EXISTS /*_*/hitcounter (
...
--
CREATE TABLE IF NOT EXISTS /*_*/ipblocks (
...
--
CREATE TABLE IF NOT EXISTS /*_*/image (
  -- Filename.
...
--
CREATE TABLE IF NOT EXISTS /*_*/oldimage (
...
--
CREATE TABLE IF NOT EXISTS /*_*/filearchive (
  -- Unique row id
...
--
CREATE TABLE IF NOT EXISTS /*_*/recentchanges (
...
CREATE TABLE IF NOT EXISTS /*_*/watchlist (
  -- Key to user.user_id
...
--
CREATE TABLE IF NOT EXISTS /*_*/math (
...
-- fulltext index.
--
CREATE TABLE IF NOT EXISTS /*_*/searchindex (
  -- Key to page_id
...
--
CREATE TABLE IF NOT EXISTS /*_*/interwiki (
...
--
CREATE TABLE IF NOT EXISTS /*_*/querycache (
...
--
CREATE TABLE IF NOT EXISTS /*_*/objectcache (
...
--
CREATE TABLE IF NOT EXISTS /*_*/transcache (
...
CREATE TABLE IF NOT EXISTS /*_*/logging (
...
CREATE TABLE IF NOT EXISTS /*_*/log_search (
...
CREATE TABLE IF NOT EXISTS /*_*/trackbacks (
...
CREATE TABLE IF NOT EXISTS /*_*/job (
...
CREATE TABLE IF NOT EXISTS /*_*/querycache_info (
  -- Special page name
...
CREATE TABLE IF NOT EXISTS /*_*/redirect (
...
CREATE TABLE IF NOT EXISTS /*_*/querycachetwo (
  -- A key name, generally the base name of of the special page.
...
CREATE TABLE IF NOT EXISTS /*_*/page_restrictions (
...
CREATE TABLE IF NOT EXISTS /*_*/protected_titles (
...
CREATE TABLE IF NOT EXISTS /*_*/page_props (
...
CREATE TABLE IF NOT EXISTS /*_*/updatelog (
  ul_key varchar(255) NOT NULL PRIMARY KEY
) /*$wgDBTableOptions*/;


-- A table to track tags for revisions, logs and recent changes.
CREATE TABLE IF NOT EXISTS /*_*/change_tag (
  -- RCID for the change
  ct_rc_id int NULL,
...
CREATE TABLE IF NOT EXISTS /*_*/tag_summary (
  -- RCID for the change  
  ts_rc_id int NULL,
  -- LOGID for the change
  ts_log_id int NULL,
...
CREATE TABLE IF NOT EXISTS /*_*/valid_tag (
  vt_tag varchar(255) NOT NULL PRIMARY KEY
) /*$wgDBTableOptions*/;

-- Table for storing localisation data
CREATE TABLE IF NOT EXISTS /*_*/l10n_cache (
  -- Language code
